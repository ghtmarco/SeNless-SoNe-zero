  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        title: const Text('Shopping Cart', style: AppTextStyles.headingMedium),
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Your cart is empty', style: AppTextStyles.headingSmall),
          const SizedBox(height: AppDimensions.marginMedium),
          const Text('Add some video tapes to get started!',
          ...
          child: Row(
            children: [
              ClipRRect(
                ...
                child: Image.network(
                  Platform.isAndroid
                      ? 'http://10.0.2.2:3000${item.tape.imageUrls.first}'
                      : 'http://localhost:3000${item.tape.imageUrls.first}',
                  width: 80,
                  height: 80,
                  fit: BoxFit.cover,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('\$${item.tape.price.toStringAsFixed(2)}',
